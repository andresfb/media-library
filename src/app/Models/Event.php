 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Event whereItemId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Event whereRequester($value)
